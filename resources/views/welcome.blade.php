...
<body>
                ...
                <div class="col-lg-12 col-md-12 col-12">
                    <div class="row justify-content-center">
                        <div class="col-lg-1 col-md-1 col-2">
                            <h1 class="aboutHeading mt-5 wow bounceInDown" data-wow-duration="3s" data-wow-delay="1s">
                                Why Us?</h1>
                        </div>
                        <div class="col-lg-4" style="background-image: url('../images/about_background.jpg')">

                        </div>
                        <div class="about-card col-lg-7 col-md-11 col-10 wow fadeIn mt-4" data-wow-duration="3s"
                            data-wow-delay="0.5s">
    ...
    <section class="header-about">
        <div class="container">
            <div class="container headings text-center">
                <h1 class="font-weight-bold text-center wow fadeInLeft">About Us</h1>
                <p class="text-center wow fadeIn">Find out about us</p>
            </div>
            <div class="row">
            ...
            <div class="row text-center mt-4">
                <div class="col-lg-12 col-10 more">
                    <p><a href="{{ route('products') }}" class="wow fadeInUp" data-wow-duration="2s"
                            data-wow-delay="5.5s">More Products <i class="fa fa-angle-right"></i></a></p>
                </div>
            </div>
