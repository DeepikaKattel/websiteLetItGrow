            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 about-contentWrap">
                        ...
                        <div class="image-wrap wow slideInRight" data-wow-duration="1.5s" data-wow-delay="0.1s"><img width="291" height="293" src="{{asset('images/office.jpg')}}" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="vision-img"></div>
                        <div class="content-wrap wow slideInLeft" data-wow-duration="1.5s" data-wow-delay="0.1s" style="text-align:justify;">
