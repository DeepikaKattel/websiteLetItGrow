<footer class="footer" id="footerDiv">
    <div class="row">
        <div class="col-lg-4 col-md-4 col-12 footer-div wow slideInLeft" data-wow-duration="3s" data-wow-delay="2.5s"
        ...
        <div class="col-lg-2 col-md-2 col-12 footer-div wow slideInLeft" data-wow-duration="3s" data-wow-delay="2s"
            ...
            <li><i class="fas fa-briefcase"></i><a href="{{ route('career') }}">Career</a>
            </li>
        ...
        <div class="col-lg-4 col-md-4 col-12 footer-div wow slideInLeft" data-wow-duration="3s" data-wow-delay="1.5s"
            ...
            <h3>Our Services</h3>
            <hr class="rounded" style="border-top: 1px solid #ffffff;border-radius: 2px;">
            <li><i class="fas fa-window-restore"></i><a href="https://letitgrownepal.com/services">Web and Mobile
                    App
                    Development</a></li>
            <li><i class="fas fa-pen-fancy"></i><a href="https://letitgrownepal.com/services">UI and UX Graphic
                    Design</a></li>
        ...
        <div class="col-lg-2 col-md-2 col-12 footer-div  wow slideInLeft" data-wow-duration="3s" data-wow-delay="1s"
            ...
            <h3>Find Us</h3>
            <hr class="rounded" style="border-top: 1px solid #ffffff;border-radius: 2px;">
            <li><a href="https://www.facebook.com/LetITGrowNepal/"><i class="fab fa-facebook-f"></i> Facebook </a>
            </li>
            <li><a href="https://www.linkedin.com/company/let-it-grow-nepal/"><i
                        class="fab fa-linkedin"></i>LinkedIn</a></li>
            <li><a href="https://www.instagram.com/letitgrownepal/"><i class="fab fa-instagram"></i> Instagram </a>
            </li>
            <li><a
